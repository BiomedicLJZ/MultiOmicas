...
gsms <- paste0("00000XXXXXXXXXXXXXXXXXXXX11111XXXXXXXXXXXXXXXXXXXX",
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX22222XXXXXXXXXXXXX",
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX33333XXXXXXXXXXXX",
        "XXXXXX")
...
gs <- factor(sml)
groups <- make.names(c("control","surround","tumor","recurrente"))
levels(gs) <- groups
gset$group <- gs
...
cts <- c(paste(groups[1],"-",groups[2],sep=""), paste(groups[1],"-",groups[3],sep=""), paste(groups[1],"-",groups[4],sep=""))
...
par(mar=c(7,4,2,1))
title <- paste ("GSE13507", "/", annotation(gset), sep ="")
boxplot(ex[,ord], boxwex=0.6, notch=T, main=title, outline=FALSE, las=2, col=gs[ord])
legend("topleft", groups, fill=palette(), bty="n")

# expression value distribution
par(mar=c(4,4,2,1))
title <- paste ("GSE13507", "/", annotation(gset), " value distribution", sep ="")
